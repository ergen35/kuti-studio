...
const en: TranslationTable = {
  ...
  storyScenes: "Scenes",
  storyHubTitle: "Narrative hierarchy",
  storyHubIntro: "The story system is split across dedicated screens for tomes, chapters, and scenes. Use the hub to move through the hierarchy without crowding one page.",
  storyTomesIntro: "Structure volumes and keep their summaries, status, and order on a dedicated screen.",
  storyChaptersIntro: "Work chapter by chapter inside the selected tome.",
  storyScenesIntro: "Edit scenes, references, and generation links inside a focused scene screen.",
  backToStoryHub: "Back to story hub",
  openTomes: "Open tomes",
  openChapters: "Open chapters",
  openScenes: "Open scenes",
  createTome: "Create tome",
  createChapter: "Create chapter",
  createScene: "Create scene",
  saveTome: "Save tome",
  saveChapter: "Save chapter",
  saveScene: "Save scene",
  selectTome: "Select tome",
...
const fr: TranslationTable = {
  ...
  storyline: "Storyline",
  storyHub: "Hub narratif",
  storyTomes: "Tomes",
  storyChapters: "Chapitres",
  storyScenes: "Scenes",
  storyHubTitle: "Hierarchie narrative",
  storyHubIntro: "Le systeme story est decoupe en ecrans dedies pour les tomes, chapitres et scenes. Le hub permet de naviguer dans la hierarchie sans saturer une seule page.",
  storyTomesIntro: "Structurez les volumes et gardez leur resume, statut et ordre dans un ecran dedie.",
  storyChaptersIntro: "Travaillez chapitre par chapitre dans le tome selectionne.",
  storyScenesIntro: "Editez les scenes, references et liens de generation dans un ecran focalise.",
  backToStoryHub: "Retour au hub story",
  openTomes: "Ouvrir les tomes",
  openChapters: "Ouvrir les chapitres",
  openScenes: "Ouvrir les scenes",
  createTome: "Creer un tome",
  createChapter: "Creer un chapitre",
  createScene: "Creer une scene",
  saveTome: "Enregistrer le tome",
  saveChapter: "Enregistrer le chapitre",
  saveScene: "Enregistrer la scene",
  selectTome: "Selectionner un tome",
  selectChapter: "Selectionner un chapitre",
